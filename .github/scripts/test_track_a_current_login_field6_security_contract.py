...
V4_CONTRACT = ROOT / "docs/agents/contracts/TRACK_A_INDEPENDENT_EPHEMERAL_PHYSICAL_RUNTIME_V4.md"

EXPECTED_RUNNER = "molehill-otclient-v7-01"
EXPECTED_GUEST = "OTClientV7Clean"
EXPECTED_ROOTFS_SHA = "915b4be62933475c3fb5f5031aa2e159294db95fb32aaa9e8b317aadcb6c065d"
EXPECTED_ADMISSION = "PR_758_COMMENT_5469433732"
...
live_required = (
    ...
    f"independent_x11_socket_dir: {EXPECTED_X11_SOCKET_DIR}",
    f"independent_x11_socket_dir_mode: {EXPECTED_X11_SOCKET_DIR_MODE}",
...
x11_marker = '- name: Prove local X11 socket namespace'
expected_label = "runs-on: ${{ format('field6-v7-{0}', github.event.comment.id) }}"
for required in (
    expected_label,
    ...
    f"EXPECTED_X11_SOCKET_DIR: {EXPECTED_X11_SOCKET_DIR}",
    f"EXPECTED_X11_SOCKET_DIR_MODE: '{EXPECTED_X11_SOCKET_DIR_MODE}'",
...
for forbidden in ("field6-v6-{0}", "molehill-otclient-v6-01", "OTClientV6Clean", "runs-on: [otclient, synology]"):
...
if "molehill-otclient-v6-01" in helper:
    raise SystemExit("FIELD6_SECURITY_CONTRACT_RED: V6 runner remains accepted by helper")

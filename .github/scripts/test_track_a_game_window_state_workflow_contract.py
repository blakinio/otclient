...
required = (
    ...
    'id: current_target',
    'READ_ONLY_CURRENT_TARGET_REFRESH=PASS',
    'CURRENT_UNIQUE_CANDIDATE_NOT_CANONICAL_CONTAINER',
    'READ_ONLY_TARGET_RUNTIME_REVALIDATION=PASS',
    'steps.current_target.outputs.container',
    'steps.current_target.outputs.pid',
    'steps.current_target.outputs.start_ticks',

...
- The greenfield Oteryn Rust workspace has a pinned toolchain, `oteryn-architecture-check`, locked dependency policy, unsafe-forbidden workspace lints, synthetic valid/invalid dependency graphs and additive Windows plus supply-chain CI. Product application, renderer, protocol, domain, UI, asset, audio and feature crates remain deliberately absent until their bounded work packages start.

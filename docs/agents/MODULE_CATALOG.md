...
| Oteryn synthetic asset schema/compiler | active PR #92 | `AssetId`, `AssetKind`, `AssetMetadata`, `AssetRecord`, `AssetPack`, `AssetError`, `compile_manifest`, `CompilerError`; deterministic schema/pack v1 and bounded offline manifest compiler | `oteryn-client/crates/asset-types/**`, `oteryn-client/tools/asset-compiler/**`, `oteryn-client/assets/test-fixtures/synthetic-v1/**`, `oteryn-client/docs/research/assets/W6_FORMAT_AND_SECURITY_EVIDENCE.md` | Original/synthetic blob and RGBA8 inputs only. Exact `sha2 0.11.0` with defaults off plus existing `serde_json 1.0.145`; strict limits/path/symlink/containment/regular-file/output rules. No asset runtime, renderer integration, real importer, proprietary bytes, updater/signing or production compatibility claim. |

...
| `../../oteryn-client/docs/agents/CURRENT_PARALLEL_WAVE.md` | Current accepted W5 plan. It authorizes one renderer-surface worker only after the plan lifecycle merges. |
...
| `../../oteryn-client/docs/agents/prompts/COORDINATOR_AGENT.md` | Copy-ready W5 coordinator prompt. |
| `../../oteryn-client/docs/agents/prompts/WORKER_AGENT_BASE.md` | Common prefix for parallel workers. |
| `../../oteryn-client/docs/agents/prompts/NEXT_RENDERER_SURFACE_AGENT.md` | Copy-ready bounded W5 renderer-surface worker prompt. |
...
W1, W2, W3 and W4 are completed and cannot be relaunched. W5 contains exactly one implementation lane for the bounded renderer surface-ownership spike after its plan and plan archive merge. No game rendering, asset, shader-framework, UI, protocol, product-feature or secondary worker is authorized by that plan.

...
|---|---|---|
| `OTC-BE4F48-QT-1CD26E-CALL-INPUTS` | `docs/agents/prompts/OTC_BE4F48_QT_1CD26E_CALL_INPUTS.md` | One exact Qt callsite: bounded receiver input projection; source-only. |

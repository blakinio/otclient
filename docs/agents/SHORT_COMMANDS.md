...
|---|---|---|
| `OTC-BE4F48-QT-ACTIVATE-GNUHASH-DEFINITION` | `docs/agents/prompts/OTC_BE4F48_QT_ACTIVATE_GNUHASH_DEFINITION.md` | One exact packaged QtCore dynamic definition through selected GNU hash path; source-only. |

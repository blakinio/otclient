...
|---|---|---|
| `OTC-BE4F48-QUEUE-PLT-INDEXED-RECORD` | `docs/agents/prompts/OTC_BE4F48_QUEUE_PLT_INDEXED_RECORD.md` | Selected PLT selector and one indexed dynamic relocation record; source-only. |

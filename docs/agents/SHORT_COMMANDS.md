...
|---|---|---|
| `OTC-BE4F48-QUEUE-DD8DF0-STACK-CONSTRUCTION` | `docs/agents/prompts/OTC_BE4F48_QUEUE_DD8DF0_STACK_CONSTRUCTION.md` | One exact callable: private-stack construction and pointer escape; source-only. |

...
- PR #26 synchronization and PR #25 audit are merged into `main`.
- Current clean base: `6e30c340c26f3d1fdb1ffacb17cc30a172392dca`.
...
- Created backup branch `backup/OTC-20260726-characterlist-recreation-pre-restack` at the original head.
...
| Force-restack only after creating a backup ref | Removes historical stack noise without risking loss of the reviewed implementation | none |
...
- Backup branch preserves the original stacked implementation until merge completion.

...
updated: 2026-07-29T12:50:00+02:00
...
## 2026-07-29 final Windows validation and W4 stabilization
...
- Before auto-merge could execute, W4 planning and lifecycle work advanced `main`; every intervening restack preserved the exact nine-file scope and used a dedicated backup branch.
- Head `94061a65d3e1d0961c9c95022c18da484788ab99` started run `30443793680`, whose Fast/Lua/luacheck/cppcheck checks were green and Windows matrix was active when W4 implementation PR #79 moved `main`.
- W4 plan, application shell, closure and all lifecycle archives are now fully merged through PR #82. Current `main` is `e9bcc172f005fb9993178b17f630acf382656090`, no next worker is pre-claimed, and only `docs/agents/CHANGELOG.md` overlaps the nine owned paths.
- Preserved `94061a65d3e1d0961c9c95022c18da484788ab99` as `backup/OTC-20260726-client-assets-release-selection-pre-20260729-restack-7` before rebuilding on the stable base.
- The final changelog retains the merged Windows application shell, records release selection as implemented, and leaves only Reward Wall byte semantics plus rendering/preload ordering deferred.
- Real-release rehearsal remains unperformed and production runtime archive compatibility is still not claimed.
...
| `a26efb7af14afe39e310cb393b130d4270fc1673` | run `30438208569`: Lua, full Windows matrix, CMake Tests/CTest, `CI / Required` job `90547397445` | PASS; superseded because W4 moved `main` |
| `94061a65d3e1d0961c9c95022c18da484788ab99` | run `30443793680` | superseded while Windows matrix was active because W4 implementation/lifecycle moved `main` |
...
1. Pass the stable current-base head's exact-head Windows CMake Tests/CTest, required Windows matrix and `CI / Required`.

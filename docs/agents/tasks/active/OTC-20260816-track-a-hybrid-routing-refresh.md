...
The implementation task is now closed and archived by merged PR #341 at `docs/agents/tasks/archive/OTC-20260816-linux-ci-hybrid.md`; this restack consumes the archived result rather than a stale active-task path.
...
FACTS:
  ...
  - PR #341 archived and released the #331 implementation task ownership.
  ...
  - universal Track A entrypoints require the hybrid routing contract on this branch.
UNKNOWN:

...
Evidence-only closeout retains analyzer/workflow unchanged from audited head. The final evidence commit must independently satisfy exact-head checks before consumption.

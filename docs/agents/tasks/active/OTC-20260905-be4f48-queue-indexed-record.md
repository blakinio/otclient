...
stall_warnings: 0
owned_paths:
  - tools/tibia_re_be4f48_queue_index/**
  - .github/workflows/tibia-re-be4f48-queue-index.yml
  - docs/agents/tasks/active/OTC-20260905-be4f48-queue-indexed-record.md
  - docs/agents/evidence/OTC-20260905-be4f48-queue-indexed-record/**
modules_touched: []
reuses:

...
updated_at: 2026-09-06T18:48:00+02:00
...
- add a PR-head hosted standalone build gate to the existing physical workflow so the exact character-helper compile command is exercised before future merge;

...
- [ ] Hosted RED causal; physical job SKIPPED.
- [ ] Minimal GREEN rotates workflow/task current generation V6 -> V7 and returns task to static-safe `runtime_access:none`, budget 0.

...
dependency = root / 'tools/tibia_re_current_login_field6_callsite_owner/producer_dependency.py'
...
assert dependency.exists(), 'producer dependency discriminator not implemented'
...
for required in (
    'PRODUCER_DEPENDENCY_GUARD',
    'HANDLER_MEMBER_OFFSET_0X10',
    'DEPENDENCY_VIRTUAL_SLOT_0X98',
    'DEPENDENCY_TARGET_0XE195B0',
    'RTTI_OWNER_RECOVERY',
    'NO_SEMANTIC_GUESSING',
    "result['producer_dependency_guard']",
):
...
combined = (text + member_text + focused_text + qmeta_text + dependency_text + warp_text).lower()
